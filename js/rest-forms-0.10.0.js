...
function App() {
  ...
  this._addControl = function(ctrlId, ctrlType, ctrlLabel, ctrlPlaceholder, required, validation) {
...
console.log('validation == undefined'+(validation==undefined));
          ctrl = '<input class="decorate" id="'+ctrlId
...
*/
this.sendMessage = function(mep, msgName, msg, redirect, wp_callback, proxy) {
